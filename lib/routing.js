...
class Routing {
    ...
    route() {
        return new Promise((resolve) => {
            ...
            if (this.isRegisterUpdateRequest()) {
                return resolve({
                    path: BaseApp.HANDLER_ON_REGISTER_UPDATE,
                    type: BaseApp.REQUEST_TYPE_ENUM.ON_REGISTER_UPDATE,
                });
            }
    ...
    /**
     * Type of request is Register Update
     * @private
     * @return {boolean}
     */
    isRegisterUpdateRequest() {
        const requestType = this.jovo.getPlatform().getRequestType();

        return requestType === BaseApp.REQUEST_TYPE_ENUM.ON_REGISTER_UPDATE;
    }
