...
class GoogleAction extends Platform {
    ...
    /**
     * Returns list of given by user permissions
     * @public
     * @return {*}
     */
    getUserPermissions() {
        return this.request.getGoogleActionRequest().getUserPermissions();
    }
    ...
    /**
     * Returns register update status after register update
     * @public
     * @return {null|string}
     */
    getRegisterUpdateStatus() {
        return this.request.getGoogleActionRequest().getRegisterUpdateStatus();
    }
    ...
    /**
     * Ask for permissions for sending push notifications
     * @public
     * @param {string} actionName getting permission for
     * @param {string} speech
     */
    askForNotificationPermission(actionName, speech) {
        this.response.addAskForNotificationPermission(actionName, speech);
        this.jovo.emit('respond', this.jovo);
    }
    ...
    /**
     * Ask for register updates
     * @param {string} speech
     * @param {string} intent Intent name on Dialogflow
     * @param {Array<any>} parameters Intent arguments
     * @param {string} frequency Frequency of the updates
     * @see {@link https://developers.google.com/actions/assistant/updates/daily}
     */
    askForRegisterUpdate(speech, intent, parameters, frequency) {
        this.response.addAskForRegisterUpdate(intent, parameters, frequency);
