...
class GoogleActionRequest {
    ...
    /**
     * Returns true if request is a Register Update intent
     * @return {boolean}
     */
    isRegisterUpdateIntent() {
        return _.get(this, 'inputs[0].intent') === 'actions.intent.REGISTER_UPDATE';
    }
    ...
    /**
     * Register update status after register update flow
     * @return {null|string}
     */
